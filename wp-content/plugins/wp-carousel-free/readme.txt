...
<ul>
	<li><a target="_blank" href="http://shapedplugin.com/demo/wordpress-carousel-pro/">Live Demo</a></li>
	<li><a target="_blank" href="http://shapedplugin.com/plugin/wordpress-carousel-pro/">Upgrade to the WordPress Carousel Pro</a></li>
</ul>
...
Want more features? This plugin has a <a target="_blank" href="http://shapedplugin.com/plugin/wordpress-carousel-pro/">Premium Version</a> with cool features. Check it out now!


<h4>Pro Version Advanced Features:</h4>
<ul>
	<li>Carousel with Auto Play Off, Time, bullets, colors, links, number</li>
	<li>Rearrange order of carousel items</li>
	<li>25+ Carousel Example Live Demos</li>
	...
	<li>Logo Carousel with custom number</li>
	<li>Carousel Slider with different effects</li>
	<li>Carousel Post Slider from different Posts, Page, Category</li>
	<li>Carousel Items from multiple category</li>
	<li>Custom Post Carousel with Excerpt</li>
	<li>Carousel from post without Readmore</li>
	<li>Carousel from post with image only</li>
	<li>Carousel items auto & fixed height option</li>
	<li>Testimonial Carousel Slider with different styles</li>
	<li>Carousel Slider from WooCommerce Product</li>
	<li>Carousel from WooCommerce Product Category</li>
	<li>Carousel with Lightbox</li>
	<li>Carousel with Lightbox and Bullets</li>
	<li>Lightbox Carousel without Nav Arrow</li>
	<li>Carousel item stop on hover option</li>
	<li>24 Hours Instant Support from expert people</li>
	<li>And Many More</li>
</ul>
...
<h4>Video Tutorial for WordPress Carousel Free</h4>

https://www.youtube.com/watch?v=hX84VfMKOBA




<h4><a target="_blank" href="http://shapedplugin.com/plugin/wordpress-carousel-pro/">Buy Premium Version Now! Only $29</a></h4>
