<?php
	...
	wp_enqueue_script( 'flipgallery_singlePageNav', get_template_directory_uri() . '/js/jquery.singlePageNav.min.js', array( 'jquery' ), '1.2.0', true);
	//=================================================================

	//jquery.fancybox.pack ========================================
	wp_enqueue_script( 'flipgallery_fancybox', get_template_directory_uri() . '/js/jquery.fancybox.pack.js', array( 'jquery' ), '2.1.5', true);
	//=================================================================

	//Fullscreen slider ========================================
	wp_enqueue_script( 'flipgallery_slitslider', get_template_directory_uri() . '/js/jquery.slitslider.js', array( 'jquery' ), '1.1.0', true);
	//=================================================================
