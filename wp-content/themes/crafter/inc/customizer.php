...
function crafter_customize_register( $wp_customize ) {
	...
	if ( ! empty( $sections_items ) ) {
		...
		//Default order
		$sections_sorted['crafter_welcomeblog_section'] = 01;
	    ...
	    $sections_sorted['crafter_blog_section'] = 90;
			$sections_sorted['crafter_blogcarrousel_section'] = 91;
			$sections_sorted['crafter_triggetriggers_section'] = 92;
			$sections_sorted['crafter_imagetxt_section'] = 100;
			$sections_sorted['crafter_textimg_section'] = 110;
	}
    ...
    $wp_customize->add_panel( 'crafter_front_page_sections', array(
		'title' => esc_attr__( 'Seções da página inicial', 'crafter' ),
		...
		Welcome Blog
		------------------------------ */
		$wp_customize->add_section( 'crafter_welcomeblog_section', array(
		'title' => esc_attr__( 'Welcome Blog', 'crafter' ),
		'description' => esc_attr__( 'Mostra os ultimos 2 posts em destaque em full width.', 'crafter' ),
		'panel' => 'crafter_front_page_sections',
		'priority' => $sections_sorted['crafter_welcomeblog_section'],
		) );

		$wp_customize->add_setting( 'crafter_welcomeblog_enable', array( 'default' => true, 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_bool', ) );
			$wp_customize->add_control( 'crafter_welcomeblog_enable', array(
			'section' => 'crafter_welcomeblog_section', // Required, core or custom.
			'label' => esc_attr__( "Usar esta seção?", 'crafter' ),
			'type'    => 'checkbox',
		) );
		...
		/*
			Image-text
			------------------------------ */
			$wp_customize->add_section( 'crafter_imagetxt_section', array(
			  'title' => esc_attr__( 'Image Text', 'crafter' ),
			  'description' => esc_attr__( 'Mostra uma imagem com legendas e um blodo de texto a direita.', 'crafter' ),
			  'panel' => 'crafter_front_page_sections',
			  'priority' => $sections_sorted['crafter_imagetxt_section'],
			) );

			$wp_customize->add_setting( 'crafter_image_ttl_title', array( 'default' => esc_attr__( 'Impactful Projects', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_image_ttl_title', array(
			  'type' => 'text',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( 'Título na imagem', 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_image_main_desc', array( 'default' => esc_html__( 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nullam quis risus eget urna mollis ornare vel eu leo. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna.', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_textarea', ) );
			$wp_customize->add_control( 'crafter_image_main_desc', array(
			  'type' => 'textarea',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( 'Texto na imagem', 'crafter' ),
			  //'description' => esc_attr__( '', 'crafter' ),
			) );


			$wp_customize->add_setting( 'crafter_image_link_title', array( 'default' => esc_html__( 'Learn More', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_image_link_title', array(
			  'type' => 'text',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( "Titulo do link", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_image_link_url', array( 'default' => '#', 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_url', ) );
			$wp_customize->add_control( 'crafter_image_link_url', array(
			  'type' => 'url',
			  'section' => 'crafter_imagetxt_sectionn', // Required, core or custom.
			  'label' => esc_attr__( "Link URL", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_image_image', array( 'default' => '', 'transport' => 'postMessage', 'sanitize_callback' => 'attachment_url_to_postid', ) );
			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'crafter_image_image', array(
			      'label'    => esc_attr__( 'Main Image', 'crafter' ),
			      'section'  => 'crafter_imagetxt_section',
			      'settings' => 'crafter_image_image',
			) ) );


			//  text area
			$wp_customize->add_setting( 'crafter_txt_title', array( 'default' => esc_html__( 'Praesent commodo cursus magna, vel scelerisque nisl consectetur et', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_txt_title', array(
			  'type' => 'text',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( "Titulo do texto", 'crafter' ),
			) );

			/* translators: Lorem ipsum text, It is not strictly necessary to translate. */
			$wp_customize->add_setting( 'crafter_txt_text', array( 'default' => esc_html__( 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nullam quis risus eget urna mollis ornare vel eu leo. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna.', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text_html', ) );
			$wp_customize->add_control( 'crafter_txt_text', array(
			  'type' => 'textarea',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( 'Texto', 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_txt_link_title', array( 'default' => esc_html__( 'Learn More', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_txt_link_title', array(
			  'type' => 'text',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( "Título do link", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_txt_link_url', array( 'default' => '', 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_url', ) );
			$wp_customize->add_control( 'crafter_txt_link_url', array(
			  'type' => 'url',
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( "Link URL", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_imagetxt_enable', array( 'default' => true, 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_bool', ) );
			  $wp_customize->add_control( 'crafter_imagetxt_enable', array(
			  'section' => 'crafter_imagetxt_section', // Required, core or custom.
			  'label' => esc_attr__( "Usar esta seção?", 'crafter' ),
			  'type'    => 'checkbox',
			) );
			...
			/*
				Text Image
				------------------------------ */
			$wp_customize->add_section( 'crafter_textimg_section', array(
			  'title' => esc_attr__( 'Text Image', 'crafter' ),
			  'description' => esc_attr__( 'Mostra um bloco de texto com uma imagem com legendas a direita.', 'crafter' ),
			  'panel' => 'crafter_front_page_sections',
			  'priority' => $sections_sorted['crafter_textimg_section'],
			) );

			//  text area
			$wp_customize->add_setting( 'crafter_in_txt_title', array( 'default' => esc_html__( 'Praesent commodo cursus magna, vel scelerisque nisl consectetur et', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_in_txt_title', array(
			  'type' => 'text',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( "Titulo do texto", 'crafter' ),
			) );

			/* translators: Lorem ipsum text, It is not strictly necessary to translate. */
			$wp_customize->add_setting( 'crafter_in_txt_text', array( 'default' => esc_html__( 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nullam quis risus eget urna mollis ornare vel eu leo. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna.', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text_html', ) );
			$wp_customize->add_control( 'crafter_in_txt_text', array(
			  'type' => 'textarea',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( 'Texto', 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_in_txt_link_title', array( 'default' => esc_html__( 'Learn More', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_in_txt_link_title', array(
			  'type' => 'text',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( "Título do link", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_in_txt_link_url', array( 'default' => '', 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_url', ) );
			$wp_customize->add_control( 'crafter_in_txt_link_url', array(
			  'type' => 'url',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( "Link URL", 'crafter' ),
			) );
			...
			$wp_customize->add_setting( 'crafter_in_image_ttl_title', array( 'default' => esc_attr__( 'Impactful Projects', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_in_image_ttl_title', array(
			  'type' => 'text',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( 'Título na imagem', 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_in_image_main_desc', array( 'default' => esc_html__( 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nullam quis risus eget urna mollis ornare vel eu leo. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Praesent commodo cursus magna.', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_textarea', ) );
			$wp_customize->add_control( 'crafter_in_image_main_desc', array(
			  'type' => 'textarea',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( 'Texto na imagem', 'crafter' ),
			  //'description' => esc_attr__( '', 'crafter' ),
			...
			$wp_customize->add_setting( 'crafter_in_image_link_title', array( 'default' => esc_html__( 'Learn More', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
			$wp_customize->add_control( 'crafter_in_image_link_title', array(
			  'type' => 'text',
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( "Titulo do link", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_in_image_link_url', array( 'default' => '#', 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_url', ) );
			$wp_customize->add_control( 'crafter_in_image_link_url', array(
			  'type' => 'url',
			  'section' => 'crafter_textimg_sectionn', // Required, core or custom.
			  'label' => esc_attr__( "Link URL", 'crafter' ),
			) );

			$wp_customize->add_setting( 'crafter_in_image_image', array( 'default' => '', 'transport' => 'postMessage', 'sanitize_callback' => 'attachment_url_to_postid', ) );
			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'crafter_in_image_image', array(
			      'label'    => esc_attr__( 'Main Image', 'crafter' ),
			      'section'  => 'crafter_textimg_section',
			      'settings' => 'crafter_in_image_image',
			) ) );


			$wp_customize->add_setting( 'crafter_textimg_enable', array( 'default' => true, 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_bool', ) );
			  $wp_customize->add_control( 'crafter_textimg_enable', array(
			  'section' => 'crafter_textimg_section', // Required, core or custom.
			  'label' => esc_attr__( "Usar esta seção?", 'crafter' ),
			  'type'    => 'checkbox',
			) );
		...
		/*
			Blog Carousel
			------------------------------ */
		$wp_customize->add_section( 'crafter_blogcarrousel_section', array(
			'title' => esc_attr__( 'Blog Carrousel', 'crafter' ),
			'description' => esc_attr__( "Mostra os posts em uma seção da página em um carrousel usando o plugin WP Posts Carrousel.", 'crafter' ),
			'panel' => 'crafter_front_page_sections',
			'priority' => $sections_sorted['crafter_blogcarrousel_section'],
		) );

		$wp_customize->add_setting( 'crafter_blogcarrousel_title', array( 'default' => esc_html__( 'Blog', 'crafter' ), 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_text', ) );
		$wp_customize->add_control( 'crafter_blogcarrousel_title', array(
			'type' => 'text',
			'section' => 'crafter_blogcarrousel_section', // Required, core or custom.
			'label' => esc_attr__( "Section Title", 'crafter' ),
		) );

		$wp_customize->add_setting( 'crafter_blogcarrousel_enable', array( 'default' => true, 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_bool', ) );
			$wp_customize->add_control( 'crafter_blogcarrousel_enable', array(
			'section' => 'crafter_blogcarrousel_section', // Required, core or custom.
			'label' => esc_attr__( "Usar esta seção?", 'crafter' ),
			'type'    => 'checkbox',
		) );
		...
		/*
			Trigg / Triggers area
			------------------------------ */
		$wp_customize->add_section( 'crafter_triggetriggers_section', array(
			'title' => esc_attr__( 'Area Trigg e Triggers', 'crafter' ),
			'description' => esc_attr__( "Mostra texto explicativo da parte trigg e triggers.", 'crafter' ),
			'panel' => 'crafter_front_page_sections',
			'priority' => $sections_sorted['crafter_triggetriggers_section'],
		) );

		$wp_customize->add_setting( 'crafter_triggetriggers_enable', array( 'default' => true, 'transport' => 'postMessage', 'sanitize_callback' => 'crafter_sanitize_bool', ) );
			$wp_customize->add_control( 'crafter_triggetriggers_enable', array(
			'section' => 'crafter_triggetriggers_section', // Required, core or custom.
			'label' => esc_attr__( "Usar esta seção?", 'crafter' ),
			'type'    => 'checkbox',
		) );
