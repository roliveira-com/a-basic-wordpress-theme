    ...
    <div class="form-container">
      <form action="">
        <fieldset>
			...
			<div class="field-row">
				<div class="field-col-50">
					<h4><span>5. </span>Nome completo - Participante 1</h4>
            		<input id="nome" type="text" name="nome">
				</div>
				<div class="field-col-50">
					<h4><span>6. </span>CPF ou Nro. do Passaporte</h4>
			...
			<div class="field-row">
				<div class="field-col-50">
					<h4><span>7. </span>Gênero</h4>
					<select class="custom-option" name="gender" id="gender">
						<option value="male">Masculino</option>
						<option value="female">Feminino</option>
						<option value="noanswer">Prefiro não responder</option>
						<option value="outro">Outro (especifique)</option>
						<input class="input-other" name="gender" type="text" placeholder="especifique">
					</select>		        
				</div>
				<div class="field-col-50">
					<h4><span>10. </span>Data de Nascimento</h4>
			...
			<div class="field-row">
				<div class="field-col-50">
					<h4><span>8. </span>País de Nascimento</h4>
            		<input id="country" type="text" name="country">
				</div>
				<div class="field-col-50">
					<h4><span>9. </span>Cidade de residência</h4>
			...
			<div class="field-row">
				<div class="field-col-50">
					<h4><span>11. </span>Telefone para contato</h4>
            		<input id="phone" type="text" name="phone">
				</div>
				<div class="field-col-50">
					<h4><span>12. </span>Email</h4>
			...
			<div class="field-row">
				<div class="field-col-50">
					<h4><span>3. </span>Como ficou sabendo do Triggers powered by Visionários?</h4>
					<select class="custom-option" name="acknoledge" id="acknoledge">
						...
						<option value="outro">Outro (especifique)</option>
						<input class="input-other" name="acknoledge" type="text" placeholder="especifique">
					</select>
				</div>
				<div class="field-col-50">
					<h4><span>13. </span>Qual seu tamanho de camiseta? </h4>
					<select class="custom-option" name="acknoledge" id="acknoledge">
						...
						<option value="xgg">Extra GG</option>
					</select>
					<p class="obs">Caso seja selecionado, cada participante terá a sua.</p>			        
				</div>
			</div>


          <div class="field-box">
            <h4><span>2. </span>Você está aplicando individualmente ou em equipe?</h4>
          ...
          <div class="field-box">
            <h4><span>4. </span>Email de quem está aplicando o questionário. </h4>
        ...
        <fieldset>
          ...
          <div class="field-box">
            <h4><span>13. </span>Qual seu tamanho de camiseta? (Caso seja selecionado, cada participante terá a sua.)</h4>
          ...
          <div class="field-box">
            <h4><span>14. </span>Nível de formação</h4>
          ...
          <div class="field-box">
            <h4><span>15. </span>Renda Familiar</h4>
          ...
          <div class="field-box">
            <h4><span>16. </span>Você está empregado atualmente? Se sim, nos conte mais sobre seu trabalho, suas responsabilidades, carga horária, etc.</h4>
            <textarea name="jobdesc" id="jobdesc" cols="30" rows="10"></textarea>
          </div>

          <div class="field-box">
            <h4><span>17. </span>Linkedin</h4>
            <input id="linkedin" type="text" name="linkedin">
          </div>

          <div class="field-box">
            <h4><span>18. </span>Facebook</h4>
            <input id="facebook" type="text" name="facebook">
          </div>
        </fieldset>
        <fieldset>
          <div class="field-box">
            <h4><span>19. </span>Nos conte mais o que te levou pessoalmente a aplicar para o Triggers 2017?</h4>
            <textarea name="reasons" id="reasons" cols="30" rows="10"></textarea>
          </div>

          <div class="field-box">
            <h4><span>20. </span>Áreas sociais de interesse (Máximo 3)</h4>
          ...
          <div class="field-box">
            <h4><span>21. </span>Você já empreendeu ou atuou em alguma das áreas de interesse selecionadas? Se sim, conte-nos um pouco da sua experiência.</h4>
            <textarea name="experience" id="experience" cols="30" rows="10"></textarea>
          </div>

          <div class="field-box">
            <h4><span>22. </span>Imagine que é seu primeiro dia participando no Triggers, como você se apresentaria para seus colegas participantes?</h4>
            <textarea name="intro" id="intro" cols="30" rows="10"></textarea>
          </div>

          <div class="field-box">
            <h4><span>23. </span>O objetivo desse programa é capacitar e fomentar as equipes para que criem ideias inovadoras que gerem um impacto relevante na sociedade. Você já tem alguma ideia que gostaria de compartilhar? Se sim, nos conte mais sobre ela.</h4>
