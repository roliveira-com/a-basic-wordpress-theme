...
<div id="about-section" class="about-section" <?php if( false == $crafter_enable_section ): echo 'style="display: none;"'; endif ?>>
    ...
    <p>
      Triggers powered by Visionários é um programa de educação e investimento para empreendedores liderado pela Trigg, que tem o envolvimento de organizações sociais, como Litro de Luz, Instituto Fazendo História, Arredondar, Escola de Notícias, So+ma, além da participação de importantes empresários e executivos do país.
    </p>
    <?php
