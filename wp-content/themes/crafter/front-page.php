...
get_header(); ?>
	...
	<?php }else { ?>
		...
		<main id="main" class="site-main" role="main">
			...
			<?php
			$default_order = array( "welcomeblog", "welcome", "about", "video", "textimg",  "bullet-points", "services", "pricing", "clients", "testimonials", "blog",  "imagetxt", "triggetriggers", "blogcarrousel" );
			// $default_order = array( "welcomeblog", "about", "textimg", "imagetxt",  "services", "blogcarrousel" );
